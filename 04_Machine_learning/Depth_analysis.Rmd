...
ggsave("Figs/var_importance_depth_plot.png", plot = var_importance_depth_plot, width = 10, height = 4, dpi = 600)
```
...
ggsave("Figs/depth_shap_distribution.png", plot_dist, width = 10, height = 4, dpi = 600, bg = "white")
