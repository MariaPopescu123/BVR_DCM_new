...
This repository includes all workflows needed to reproduce the data frames and figures used in the analysis of deep chlorophyll maxima (DCM) in Beaverdam Reservoir for the project called: 
> *WILL UPDATE THIS WITH PUBLICATION NAME*
...
Finally, it calculates summary statistics for high phytoplankton concentrations (max_conc > 20), including the median, standard deviation, ±1 SD, and sample size, both for concentration and DCM depth.
