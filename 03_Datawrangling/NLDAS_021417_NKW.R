...
pacman::p_load(RCurl, lubridate, raster, ncdf4, sf, httr, terra)
...
extent = c(-82.00661916405241,29.67795510253453,-82.00661916405241,29.67795510253453)

###########################################################
### Set timeframe
###########################################################
#i get that i can change this
out = seq.POSIXt(as.POSIXct('2017-01-01 00:00',tz = 'GMT'),as.POSIXct('2020-08-31 23:00',tz='GMT'),by = 'hour')
...
cellNum = 3 #How many output cells will there be? Need to check this beforehand
for (l in 1:11){
