...
depth_analysis <- full_weekly_data %>%
  dplyr::select(Date, DCM_depth, PZ, WaterLevel_m, depth_TFe_mgL_min, depth_TFe_mgL_max, schmidt_stability, avg_airtemp_lagged, Precip_avg_lagged, PAR_umolm2s_Weekly_Avg_lagged, depth_np_ratio_min)
...
ggsave("var_importance_depth_plot.png", plot = var_importance_depth_plot, width = 10, height = 4, dpi = 600)
...
mutate(nv = scale(value))%>%
  ...
  labs(
    title = 'Distribution of SHAP values for Depth Prediction',
    y = '',
...
ggsave("depth_shap_distribution.png", plot_dist, width = 10, height = 4, dpi = 600, bg = "white")
